...
/**
 * @file
 * Display Suite Bootstrap 12 3 9 template.
 *
 * Available variables:
 *
 * Layout:
...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> clearfix">
  ...
  <?php endif; ?>
    ...
    <<?php print $left_wrapper; ?> class="col-md-3 filters-col<?php print $left_classes; ?>">
      <?php print $left; ?>
    </<?php print $left_wrapper; ?>>

    <<?php print $right_wrapper; ?> class="col-md-9 content-col<?php print $right_classes; ?>">
      <?php print $right; ?>
